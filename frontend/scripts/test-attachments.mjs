...
try {
  ...
  assert.match(editorSource, /getMarkdownDropOffset/)
  assert.match(editorSource, /captureMarkdownImagePasteContext\(\{\s*clientX: event\.clientX,\s*clientY: event\.clientY,/)
  assert.match(editorSource, /NOTE_EDITOR_DROP_POSITION_UNAVAILABLE/)
  assert.match(editorSource, /start,\s*end,/)
